...
/**
 * The IPValidator class provides methods to validate IP addresses
 * both in string format and integer format.
 * 
 * @version 1.0
 * @since 2024-05-25
 * @author Aaron Rojas
...
public class IPValidation {
     ...
     * @throws ValidationException if the integer cannot be converted to a valid IPv4 address.
     */
