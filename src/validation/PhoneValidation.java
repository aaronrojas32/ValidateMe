...
/**
 * The PhoneValidation class provides methods for validating phone numbers. It
 * uses the libphonenumber library from Google for parsing and validating phone
 * numbers.
 * 
 * @version 1.0
 * @since 2024-05-25
