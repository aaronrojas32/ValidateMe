...
/**
 * The CardException class represents an exception related to credit card operations.
 * This exception may be thrown in situations where there are errors or issues
 * with credit card validation, processing, or other credit card-related operations.
 * 
 * @version 1.0
 * @since 2024-05-20
 * @author Aarón Rojas
...
public class CardException extends Exception {
    ...
    /**
     * Default constructor for CardException.
     * Creates a new instance of CardException with no detailed message.
     */
