...
public class PhoneValidationTest {
    ...
    public void testNullPhoneNumber() {
        ...
        assertEquals("Phone number is null", exception.getMessage(), "Expected exception message for null phone number");
    }
    ...
    public void testEmptyPhoneNumber() {
        ...
        assertEquals("Phone number is empty", exception.getMessage(), "Expected exception message for empty phone number");
    }
    ...
    public void testRandomAlphanumeric() {
        ...
        assertEquals("Invalid phone number: random123", exception.getMessage(), "Expected exception message for random alphanumeric string");
    }
    ...
    public void testInvalidCountryCode() {
        ...
        assertEquals("Invalid phone number: " + invalidCountryCode, exception.getMessage(), "Expected exception message for invalid country code");
    }
    ...
    public void testTooLongPhoneNumber() {
        ...
        assertEquals("Invalid phone number: " + tooLongPhoneNumber, exception.getMessage(), "Expected exception message for too long phone number");
    }
    ...
    public void testTooShortPhoneNumber() {
        ...
        assertEquals("Invalid phone number: " + tooShortPhoneNumber, exception.getMessage(), "Expected exception message for too short phone number");
    }
}