...
public class CardValidatorTest {
    ...
    public void testDifferentCardTypes() {
        ...
        try {
            ...
            assertTrue("Valid MasterCard should pass",validator.CreditCardValidation("5105105105105100", "12/25", 123));
            assertTrue("Valid Amex card should pass", validator.CreditCardValidation("371449635398431", "12/25", 1234));
            assertTrue("Valid Discover card should pass", validator.CreditCardValidation("6011111111111117", "12/25", 123));
            assertTrue("Valid Diners Club card should pass", validator.CreditCardValidation("30569309025904", "12/25", 123));
